...
namespace Easyfood.Partners.Infrastructure.Persistence.EF.Migrations
{
    ...
    [Migration("20221020004117_Initial")]
                    ...
                    b.OwnsOne("Easyfood.Partners.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                            ...
                            b1.OwnsOne("Easyfood.Partners.Domain.ValueObjects.Location", "Location", b2 =>
                                {
                                    b2.Property<Guid>("AddressMerchantId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.HasKey("AddressMerchantId");

                                    b2.ToTable("Address");

                                    b2.WithOwner()
                                        .HasForeignKey("AddressMerchantId");
                                });
